        ...
        <>
            ...
            <div className={`${styles.container} ${styles.checkout}`}>
                ...
                <div className={styles.checkout__side}>
                    ...
                    <Summary totalAfterDiscount={totalAfterDiscount} setTotalAfterDiscount={setTotalAfterDiscount} user={user} cart={cart} paymentMethod={paymentMethod} selectedAddress={selectedAddress} />
                </div>
            </div>
        </>
    )
